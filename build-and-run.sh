...
find ./bin-int/ -type f -name '*.o' -exec rgblink -o ./bin/nauti_buoy.gb -n ./bin/nauti_buoy.sym -m ./bin/nauti_buoy.map {} +
rgbfix -f lhg -p 255 ./bin/nauti_buoy.gb

java -jar ./Emulicious/Emulicious.jar ./bin/nauti_buoy.gb