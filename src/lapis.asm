...
; $0000 - $00FF: Reserved for the Boot ROM located in the Game Boy's CPU. Therefore our entry point is $0100.

; $0100 - $0103
SECTION "Entry Point", ROM0[$0100]
; After displaying the Nintendo Logo, the built-in boot procedure jumps to $0100, which should then jump to the actual main program in the cartridge.
...
SECTION "Header", ROM0[$0104]
    ...
    ; A value of $33 signalizes that the New License Code in header bytes $0144 - $0145 is used instead. (Super GameBoy functions won't work if it isn't $33.)
    db $33
