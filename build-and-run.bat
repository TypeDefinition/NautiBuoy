...
START rgbasm -o ./bin-int/OAM-obj.o ./src/OAM.asm
START rgblink -o ./bin/lapis.gb ./bin-int/assets-obj.o ./bin-int/OAM-obj.o -n ./bin-int/symbolMap.map -m ./bin-int/SystemInfo.txt ./bin-int/lapis-obj.o
